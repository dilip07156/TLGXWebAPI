...
namespace DistributionWebApi
{
    public static class WebApiConfig
    {
        ...
        public class TextPipeMediaTypeFormatter : MediaTypeFormatter
        {
            public TextPipeMediaTypeFormatter()
            {
                this.SupportedMediaTypes.Add(new MediaTypeHeaderValue("text/csv"));
                //SupportedEncodings.Add(new UTF8Encoding(encoderShouldEmitUTF8Identifier: false));
                //SupportedEncodings.Add(Encoding.GetEncoding("iso-8859-1"));
            ...
            public TextPipeMediaTypeFormatter(MediaTypeMapping mediaTypeMapping) : this()
            {
                MediaTypeMappings.Add(mediaTypeMapping);
            }
            ...
            {
                base.SetDefaultContentHeaders(type, headers, mediaType);
                headers.Add("Content-Disposition", "attachment; filename = " + "TLGX_API_" + DateTime.Now.ToString("yyyyMMddhhmmssfff") + ".txt");
        ...
        public static void Register(HttpConfiguration config)
        {
            ...
            config.Formatters.Add(new TextPipeMediaTypeFormatter());
